...
interface ProductDetailProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onAddToCart: (product: Product, selectedSize: string, quantity: number, personalization?: {
...
export function ProductDetail({ product, isOpen, onClose, onAddToCart }: ProductDetailProps) {
  ...
  const [selectedPersonalization, setSelectedPersonalization] = useState<PersonalizationOption | null>(null);
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <RadioGroup 
                      ...
                      onValueChange={(value) => {
                        const option = product.personalizationOptions.find(opt => opt.id === value);
                      ...
                      <div className="space-y-2">
                        <div className={`flex items-center space-x-3 p-3 border rounded-lg transition-all duration-200 cursor-pointer ${
                          ...
                          <Label htmlFor="no-personalization" className="flex-1 cursor-pointer">
                            ...
                            <div className="text-sm text-muted-foreground">Camiseta tal como viene</div>
                          </Label>
                      ...
                      <div className="mt-4 p-4 bg-muted/30 border border-border rounded-lg space-y-3">
                        ...
                        {(selectedPersonalization.id === "name-number" || selectedPersonalization.id === "name-number-patch") && (
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                              <Label htmlFor="player-number" className="text-sm">Número</Label>
                              <Input
                                id="player-number"
                                placeholder="Ej: 10"
                                value={playerNumber}
                        ...
                        {selectedPersonalization.id === "patch-only" && (
                          <div>
                            <Label htmlFor="custom-text" className="text-sm">Texto personalizado</Label>
                            <Textarea
                              id="custom-text"
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Camiseta oficial del {product.team}. Fabricada con tecnología Dri-FIT que ayuda a mantener la piel seca y cómoda. 
                    Diseño auténtico con los colores y escudo del equipo. Material 100% poliéster reciclado.
                  </p>
                </div>
              </div>
            </div>
