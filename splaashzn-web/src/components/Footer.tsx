      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">FutbolShop</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-foreground transition-colors">La Liga</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Premier League</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Serie A</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Bundesliga</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors">Selecciones</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <p>&copy; 2024 FutbolShop. Todos los derechos reservados.</p>
